      ...
      >
        ...
        >
          <div class="row" style="padding: 20px 0 20px 0">
            <a href="personal_data.html" style="text-decoration: none;"><li>퍼스널 데이터</li></a>
          </div>
          <div class="row" style="padding: 20px 0 20px 0">
            <a href="group_data.html" style="text-decoration: none"><li>그룹 데이터</li></a>
          </div>
          <div class="row" style="padding: 20px 0 20px 0">
            <a href="crew.html" style="text-decoration: none"><li>크루 모집</li></a>
          </div>
          <div class="row" style="padding: 20px 0 20px 0">
            <a href="bulletin_board.html" style="text-decoration: none"><li>자유게시판</li></a>
          </div>
          <div class="row" style="padding: 20px 0 20px 0">
            <a href="faq.html" style="text-decoration: none"><li>이용 문의</li></a>
          </div>
        </ul>
      </div>
      ...
      <div class="container" style="left: 200px; width: 90%">
        <div class="row">
          ...
          <div class="container">
            ...
            <table class="table table-borderd" style="width:80%; margin:auto;">
              <tr>
                <tr>
                  <th scope="row" class="col-sm-2">제목</th><td colspan="3">온라인 예절을 지켜주세요 (2)</td>
                </tr>
                <tr>
                <th scope="row" class="col-sm-2">작성자</th><td>침착맨</td><th scope="row" class="col-sm-2">조회수</th><td>23</td>
              </tr>
              <tr>
                <th>작성일</th><td colspan="3">2022/05/03</td>
              </tr>
              <tr>
                <th>카테고리</th><td>공지</td>
              </tr>
                <td colspan="4" style="height:200px;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat aperiam molestiae distinctio sequi ducimus vel praesentium veniam, officiis inventore cum amet id dicta officia ex facere laboriosam enim magni tenetur?</td>
              </tr>
              ...
              <tr>
                ...
                <td style="text-align: right;">
                  <a href="#" style="text-decoration:none; text-align: right">댓글</a>
                  <a href="#" style="text-decoration:none; text-align: right">수정</a>
                  <a href="#" style="text-decoration:none; text-align: right">삭제</a>
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td colspan="2">
                  <input type="text" class="form-control" placeholder="댓글을 입력하세요" style="width:100%">
                </td>
                <td style="text-align: right;">
                  <button class="btn btn-light">댓글 남기기</button>
                </td>
              </tr>
            </table>
            <div class="row">
              <div class="col" style="text-align: center;">
                ...
                <button class="btn btn-warning">싫어요</button>
              </div>
            </div>
